        ...
        if self._interpolate is None:
            ...
            if not os.path.isfile(self.binfile):
                ...
                if self.is_default:
                    ...
                    print('curl https://raw.githubusercontent.com/dgerosa/dgerosa/master/checkpoints/'+self.binfileonly+'.tar.gz -o '+self.binfile+'.tar.gz; tar -xzvf '+self.binfile+'.tar.gz -C '+self.directory+'; rm '+self.binfile+'.tar.gz \n')
